...
class StudyInputForm:
    ...
    def _create_form(self):
        ...
        self.notes_text = scrolledtext.ScrolledText(
            notes_frame, height=5, font=Constants.SMALL_FONT
        )
    ...
    def _update_productivity_label(self, value):
        ...
        self.productivity_label.config(
            text=MessageGenerator.get_productivity_label(value)
        )
...
class ActionPanel:
    ...
    def _create_panel(self):
        ...
        stats_frame = tk.Frame(
            self.parent, bg=Constants.LIGHT_GRAY, relief=tk.SUNKEN, borderwidth=2
        )
...
class WeeklySummaryWindow:
    ...
    def create_window(sessions: list, stats: dict, parent: tk.Tk):
        ...
        summary_frame = tk.Frame(
            summary_window, bg=Constants.LIGHT_GRAY, relief=tk.RAISED, borderwidth=2
        )
