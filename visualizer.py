...
class Visualizer:
    ...
    def create_pie_chart(subject_time: Dict[str, int], parent_window: tk.Toplevel):
        ...
        wedges, texts, autotexts = ax.pie(
            times, labels=subjects, autopct="%1.1f%%", startangle=90, colors=colors
        )
        ...
        ax.set_title(
            "Study Time Distribution by Subject", fontsize=14, fontweight="bold"
        )
    ...
    def create_productivity_chart(sessions: List[Dict], parent_window: tk.Toplevel):
        ...
        ax.axhline(
            ...
            linestyle="--",
            linewidth=2,
            label=f"Average: {avg_productivity:.2f}",
        )
